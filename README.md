...
Say "debug" to turn off visual artifacts (debug spheres) generated by spatial sound. (Untested)
...
A. Of course! In the Hierarchy, navigate to the _MRTK XR Rig>Camera Offset>Main Camera_ and look for the script component "Audio Player." In AudioPlayer, comment out lines 12, 23, and 24. Or, you can use the verbal command "debug" (untested). No more debug points! 
